...
def test_embed_kernel_basic():
    ...
    with setup_kernel(cmd) as client:
        ...
        content = msg['content']
        nt.assert_true(content['found'])
        nt.assert_equal(content['string_form'], '10')
...
def test_embed_kernel_namespace():
    ...
    with setup_kernel(cmd) as client:
        ...
        content = msg['content']
        nt.assert_true(content['found'])
        nt.assert_equal(content['string_form'], '5')
        ...
        content = msg['content']
        nt.assert_true(content['found'])
        nt.assert_equal(content['string_form'], 'hi there')
...
def test_embed_kernel_reentrant():
    ...
    with setup_kernel(cmd) as client:
        for i in range(5):
            ...
            content = msg['content']
            nt.assert_true(content['found'])
            nt.assert_equal(content['string_form'], str(i))
