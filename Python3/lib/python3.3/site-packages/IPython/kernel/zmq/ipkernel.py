...
class Kernel(Configurable):
    ...
    def _publish_pyin(self, code, parent, execution_count):
        ...
        self.session.send(self.iopub_socket, 'pyin',
    ...
    def execute_request(self, stream, ident, parent):
        ...
        if py3compat.PY3:
            ...
            self._sys_eval_input = builtins.input
        ...
        try:
            ...
            # Restore raw_input.
             if py3compat.PY3:
                 ...
                 builtins.input = self._sys_eval_input
        ...
        if reply_content['status'] == 'ok':
            reply_content['user_variables'] = \
                         shell.user_variables(content.get('user_variables', []))
            reply_content['user_expressions'] = \
                         shell.user_expressions(content.get('user_expressions', {}))
        else:
    ...
    def apply_request(self, stream, ident, parent):
        ...
        try:
            ...
            self.session.send(self.iopub_socket, 'pyerr', reply_content, parent=parent,
