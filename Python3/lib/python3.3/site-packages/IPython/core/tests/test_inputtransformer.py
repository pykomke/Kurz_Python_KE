...
syntax = \
  dict(assign_system =
       ...
       [ ('?', 'get_ipython().show_usage()'),
         ...
         ('?%hist1', "get_ipython().magic({u}'pinfo %hist1')"),
         ('?%%hist2', "get_ipython().magic({u}'pinfo %%hist2')"),
      ...
      [ ('x3?', "get_ipython().magic({u}'pinfo x3')"),
        ...
        ('%hist1?', "get_ipython().magic({u}'pinfo %hist1')"),
        ('%hist2??', "get_ipython().magic({u}'pinfo2 %hist2')"),
        ('%%hist3?', "get_ipython().magic({u}'pinfo %%hist3')"),
        ('%%hist4??', "get_ipython().magic({u}'pinfo2 %%hist4')"),
        ('f*?', "get_ipython().magic({u}'psearch f*')"),
        ('ax.*aspe*?', "get_ipython().magic({u}'psearch ax.*aspe*')"),
        ('a = abc?', "get_ipython().set_next_input({u}'a = abc');"
                      "get_ipython().magic({u}'pinfo abc')"),
        ('a = abc.qe??', "get_ipython().set_next_input({u}'a = abc.qe');"
                          "get_ipython().magic({u}'pinfo2 abc.qe')"),
        ('a = *.items?', "get_ipython().set_next_input({u}'a = *.items');"
                          "get_ipython().magic({u}'psearch *.items')"),
        ('plot(a?', "get_ipython().set_next_input({u}'plot(a');"
       ...
       [ ('%cd', "get_ipython().magic({u}'cd')"),
         ...
         ('%cd C:\\User', "get_ipython().magic({u}'cd C:\\\\User')"),
...
syntax_ml = \
  dict(classic_prompt =
       ...
       assign_magic =
       [ [('a = %bc de \\', None),
          ('fg', u_fmt("a = get_ipython().magic({u}'bc de fg')")),
          ],
         [('a = %bc de \\', None),
          ('fg\\', None),
       ...
       assign_system =
       [ [('a = !bc de \\', None),
          ('fg', u_fmt("a = get_ipython().getoutput({u}'bc de fg')")),
          ],
         [('a = !bc de \\', None),
          ('fg\\', None),
...
def test_cellmagic():
    ...
    line_example = [('%%bar 123', None),
                    ('hello', None),
                    ('' , u_fmt("get_ipython().run_cell_magic({u}'bar', {u}'123', {u}'hello')")),
                   ]
...
def test_token_input_transformer():
    tests = [('1.2', u_fmt("Decimal ({u}'1.2')")),
             ('"1.2"', '"1.2"'),
             ]
    tt.check_pairs(transform_and_reset(decistmt), tests)
    ml_tests = \
    [ [("a = 1.2; b = '''x", None),
       ("y'''", u_fmt("a =Decimal ({u}'1.2');b ='''x\ny'''")),
      ],
      [("a = [1.2,", None),
       ("3]", u_fmt("a =[Decimal ({u}'1.2'),\n3 ]")),
      ],
