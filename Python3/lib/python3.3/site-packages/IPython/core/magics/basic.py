...
class MagicsDisplay(object):
    ...
    def _jsonable(self):
        ...
        mman = self.magics_manager
        magics = mman.lsmagic()
        for key, subdict in list(magics.items()):
            d = {}
            magic_dict[key] = d
            for name, obj in list(subdict.items()):
                try:
...
Defaulting color scheme to 'NoColor'"""
    ...
    def notebook(self, s):
        ...
        if args.export:
            ...
            elif new_format == 'ipynb' or new_format == 'json':
                new_fname = old_name + '.ipynb'
                new_format = 'json'
            elif new_format == 'py':
                new_fname = old_name + '.py'
            else:
