...
class Image(DisplayObject):
    ...
    def __init__(self, data=None, url=None, filename=None, format='png', embed=None, width=None, height=None, retina=False):
    ...
    def _repr_html_(self):
        if not self.embed:
            ...
            return '<img src="%s"%s%s/>' % (self.url, width, height)
    ...
    def _repr_png_(self):
        if self.embed and self.format == 'png':
            return self._data_and_metadata()

    def _repr_jpeg_(self):
        if self.embed and (self.format == 'jpeg' or self.format == 'jpg'):
            return self._data_and_metadata()
