...
def test_get_long_path_name_win32():
    with TemporaryDirectory() as tmpdir:
        ...
        # Make a long path.
        long_path = os.path.join(tmpdir, 'this is my long path name')
...
class TestShellGlob(object):
    ...
    @classmethod
    def setUpClass(cls):
        cls.filenames_start_with_a = list(map('a{0}'.format, list(range(3))))
        cls.filenames_end_with_b = list(map('{0}b'.format, list(range(3))))
