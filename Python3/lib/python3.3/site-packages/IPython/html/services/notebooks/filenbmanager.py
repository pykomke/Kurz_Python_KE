...
class FileNotebookManager(NotebookManager):
    ...
    def write_notebook_object(self, nb, notebook_id=None):
        ...
        try:
            ...
            raise web.HTTPError(400, 'Unexpected error while autosaving notebook: %s' % e)
        ...
        if self.save_script:
            ...
            try:
                with io.open(pypath,'w', encoding='utf-8') as f:
                    current.write(nb, f, 'py')
            except Exception as e:
                raise web.HTTPError(400, 'Unexpected error while saving notebook as script: %s' % e)
    ...
    def restore_checkpoint(self, notebook_id, checkpoint_id):
        ...
        if not os.path.isfile(cp_path):
            ...
            raise web.HTTPError(404,
                'Notebook checkpoint does not exist: %s-%s' % (notebook_id, checkpoint_id)
            )
