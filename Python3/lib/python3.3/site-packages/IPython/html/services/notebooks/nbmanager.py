...
class NotebookManager(LoggingConfigurable):
    ...
    def get_notebook(self, notebook_id, format='json'):
        """Get the representation of a notebook in format by notebook_id."""
        format = str(format)
        if format not in self.allowed_formats:
            raise web.HTTPError(415, 'Invalid notebook format: %s' % format)
    ...
    def save_new_notebook(self, data, name=None, format='json'):
        ...
        try:
            ...
            raise web.HTTPError(400, 'Invalid JSON data')
    ...
    def save_notebook(self, notebook_id, data, name=None, format='json'):
